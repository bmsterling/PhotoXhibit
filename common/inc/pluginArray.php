...
#lightbox-nav-btnPrev { 
	...
	height:63px;
	width:72px;
	background: transparent url({PXPATH}/lightbox-btn-prev.gif)  left 15% no-repeat;
}
#lightbox-nav-btnNext { 
	...
	height:63px;
	width:72px;
	background: transparent url({PXPATH}/lightbox-btn-next.gif)  right 15% no-repeat;
}
...
#lightbox-loading-link{
	width: 32px; 
	height:32px;
	background:url({PXPATH}/lightbox-ico-loading.gif) no-repeat;
	display:-moz-inline-box;
	display:inline-block;
	vertical-align:bottom;
}		
#lightbox-secNav-btnClose {
	...
	background:url({PXPATH}/lightbox-btn-close.gif) no-repeat;
	display:-moz-inline-box;
	display:inline-block;
	vertical-align:bottom;
}
